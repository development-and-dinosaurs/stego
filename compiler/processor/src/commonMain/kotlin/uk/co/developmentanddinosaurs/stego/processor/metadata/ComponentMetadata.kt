...
/**
 * Holds all the extracted information about a class annotated with @StegoNode. This is designed to
 * be serialized to JSON for consumption by another processor.
 */
@Serializable
