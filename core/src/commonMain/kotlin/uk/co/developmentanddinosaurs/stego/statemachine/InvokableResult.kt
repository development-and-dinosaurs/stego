...
sealed interface InvokableResult {
     ...
     */
    data class Success(val data: Map<String, DataValue> = emptyMap()) : InvokableResult
     ...
     */
    data class Failure(val data: Map<String, DataValue> = emptyMap(), val cause: Throwable? = null) : InvokableResult
}
