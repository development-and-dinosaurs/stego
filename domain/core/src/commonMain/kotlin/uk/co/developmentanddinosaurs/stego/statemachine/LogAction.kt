 ...
 *
 * This action is useful for debugging and tracing the state machine's execution flow. The actual
 * logging mechanism is injected via the `logger` lambda, making this action platform-agnostic.
 *
 * @property message The static string message to be logged.
 * @property logger The platform-specific logging implementation that will be called with the
 *   message.
 */
class LogAction(
