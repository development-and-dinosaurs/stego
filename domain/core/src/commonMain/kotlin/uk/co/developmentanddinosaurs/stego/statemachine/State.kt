 ...
 *
 * A state can be simple (a leaf state) or hierarchical (a parent state that contains substates). It
 * defines actions to be performed on entry and exit, and a set of transitions that can be triggered
 * by events.
 */
interface State {
  val id: String
