...
/**
 * Performs a comparison by fetching values from providers and executing a given comparison
 * operation. This function encapsulates the common logic for all comparison-based guards.
 *
...
internal fun performComparison(
  ...
  require(leftValue is Comparable<*>) {
    "Left value of type '${leftValue::class.simpleName}' is not Comparable."
  }

  return try {
    @Suppress("UNCHECKED_CAST") operation(leftValue as Comparable<Any>, rightValue)
...
/**
 * Performs an equality check by fetching values from providers. This function encapsulates the
 * common logic for all equality-based guards.
 *
