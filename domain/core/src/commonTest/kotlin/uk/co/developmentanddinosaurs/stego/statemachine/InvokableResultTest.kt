      ...
      Given("an InvokableResult.Success") {
        and("it is created with default values") {
          ...
          When("the properties are accessed") {
            Then("the data should be an empty map") { result.data.shouldBeEmpty() }
          }
        }
        ...
        and("it is created with custom data") {
          ...
          When("the properties are accessed") {
            Then("the data should match the custom data") { result.data shouldBe customData }
          }
        }
      }
