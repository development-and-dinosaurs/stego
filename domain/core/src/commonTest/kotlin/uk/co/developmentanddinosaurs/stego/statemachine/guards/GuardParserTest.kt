    ...
    BehaviorSpec({
      Given("an expression containing '=='") {
        ...
        When("the expression is parsed") {
          ...
          Then("it should produce an EqualsGuard") { guard.shouldBeInstanceOf<EqualsGuard>() }
        }
      }
      ...
      Given("an expression containing '!='") {
        ...
        When("the expression is parsed") {
          val guard = GuardParser.parse(expression)
          Then("it should produce a NotEqualsGuard") { guard.shouldBeInstanceOf<NotEqualsGuard>() }
        }
      }
      ...
      Given("an expression containing '<'") {
        ...
        When("the expression is parsed") {
          val guard = GuardParser.parse(expression)
          Then("it should produce a LessThanGuard") { guard.shouldBeInstanceOf<LessThanGuard>() }
        }
      }
      ...
      Given("an expression containing a single '!'") {
        ...
        When("the expression is parsed") {
          val guard = GuardParser.parse(expression)
          Then("it should produce a NotGuard") { guard.shouldBeInstanceOf<NotGuard>() }
        }
      }
      ...
      Given("an expression containing '&&'") {
        ...
        When("the expression is parsed") {
          val guard = GuardParser.parse(expression)
          Then("it should produce an AndGuard") { guard.shouldBeInstanceOf<AndGuard>() }
        }
      }
      ...
      Given("an expression containing '||'") {
        ...
        When("the expression is parsed") {
          val guard = GuardParser.parse(expression)
          Then("it should produce an OrGuard") { guard.shouldBeInstanceOf<OrGuard>() }
        }
      }
      ...
      Given("an expression with unbalanced parentheses (missing closing)") {
        ...
        When("the expression is parsed") {
          Then("it should throw an IllegalArgumentException") {
            val exception = shouldThrow<IllegalArgumentException> { GuardParser.parse(expression) }
