    ...
    BehaviorSpec({
      ...
      Given("a LiteralValue provider with a string value") {
        ...
        When("the value is retrieved") {
          ...
          Then("it should return the string value") { result shouldBe "myValue" }
        }
      }
      ...
      Given("a LiteralValue provider with an integer value") {
        ...
        When("the value is retrieved") {
          ...
          Then("it should return the integer value") { result shouldBe 123 }
        }
      }
      ...
      Given("a LiteralValue provider with a null value") {
        ...
        When("the value is retrieved") {
          ...
          Then("it should return null") { result shouldBe null }
        }
      }
    })
