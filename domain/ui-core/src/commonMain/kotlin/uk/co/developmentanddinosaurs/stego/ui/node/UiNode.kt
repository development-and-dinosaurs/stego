...
/**
 * A generic handler for UI interactions that components can invoke. The key identifies the
 * interaction (e.g., "onTextChange"), and the data is any relevant payload.
 */
