...
fun RenderTextFieldUiNode(
    ...
    onStateChange(
        ...
        FieldState(
            ...
            triggerValidation = {
              ...
              return@FieldState textFieldUiNode.validators.all {
                it.validate(text) is ValidationResult.Success
              }
            },
        ),
    )
  ...
  LaunchedEffect(Unit) { validateAndReport(text) }
  ...
  TextField(
      ...
      modifier =
          Modifier.shake(if (errorMessage != null) shakeTrigger else 0).onFocusChanged { focusState
            ->
